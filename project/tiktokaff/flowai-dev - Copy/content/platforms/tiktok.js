...
(() => {
  ...
  async function getProductsForWarehouse() {
    ...
    while (pageCount < maxPages) {
      ...
      for (const row of rows) {
        try {
          ...
          console.log(`[TikTok Unlocked] Found: ${productName.substring(0, 30)}... (${cleanProductId})`);
    ...
    console.log(`[TikTok Unlocked] Scan complete. Total products: ${allProducts.length} from ${pageCount} page(s)`);
