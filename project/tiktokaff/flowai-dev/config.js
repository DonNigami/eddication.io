// Flow AI Unlocked - Configuration
// ตั้งค่า delay แบบสุ่ม (มิลลิวินาที)

const APP_CONFIG = {
  // ==================== Debug/Test Buttons ====================
  // เปิด/ปิด ปุ่มทดสอบในหน้า AI Generator
  showTestButtons: true,  // true = แสดงปุ่มทดสอบ, false = ซ่อน

  // ==================== Platform Configuration ====================
  // Supported platforms for multi-platform upload
  supportedPlatforms: ['tiktok', 'shopee', 'facebook', 'youtube'],
